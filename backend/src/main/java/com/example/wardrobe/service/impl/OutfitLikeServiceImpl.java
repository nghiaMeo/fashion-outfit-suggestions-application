...
import com.example.wardrobe.entity.OutfitLike;
import com.example.user.entity.User;
import com.example.notification.entity.enums.NotificationType;
import com.example.wardrobe.repository.OutfitLikeRepository;
    ...
    public OutfitLikeStatusResponse toggleLike(UUID outfitId, UUID ownerId) {
        ...
        if (existingLike.isPresent()) {
            ...
            if (ownerId != null && !currentUser.getId().equals(ownerId)) {
                try {
                    String content = currentUser.getDisplayName() + " is liked your outfit";
